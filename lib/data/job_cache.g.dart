...
const JobCacheSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'salary': PropertySchema(id: 7, name: r'salary', type: IsarType.string),
...
void _jobCacheSerialize(
  ...
  writer.writeString(offsets[7], object.salary);
...
JobCache _jobCacheDeserialize(
  ...
  object.salary = reader.readStringOrNull(offsets[7]);
