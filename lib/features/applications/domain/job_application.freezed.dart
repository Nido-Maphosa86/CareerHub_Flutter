...
mixin _$JobApplication {
 ...
 String get id; String get jobTitle; String get companyName; DateTime get submittedAt; ApplicationStatus get status;
...
@override
int get hashCode => Object.hash(runtimeType,id,jobTitle,companyName,submittedAt,status);
...
@useResult
$Res call({
 String id, String jobTitle, String companyName, DateTime submittedAt, ApplicationStatus status
});
...
/// Create a copy of JobApplication
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? jobTitle = null,Object? companyName = null,Object? submittedAt = null,Object? status = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String jobTitle,  String companyName,  DateTime submittedAt,  ApplicationStatus status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _JobApplication() when $default != null:
return $default(_that.id,_that.jobTitle,_that.companyName,_that.submittedAt,_that.status);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String jobTitle,  String companyName,  DateTime submittedAt,  ApplicationStatus status)  $default,) {final _that = this;
switch (_that) {
case _JobApplication():
return $default(_that.id,_that.jobTitle,_that.companyName,_that.submittedAt,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String jobTitle,  String companyName,  DateTime submittedAt,  ApplicationStatus status)?  $default,) {final _that = this;
switch (_that) {
case _JobApplication() when $default != null:
return $default(_that.id,_that.jobTitle,_that.companyName,_that.submittedAt,_that.status);case _:
  return null;
...
class _JobApplication implements JobApplication {
  const _JobApplication({required this.id, required this.jobTitle, required this.companyName, required this.submittedAt, required this.status});
...
/// Create a copy of JobApplication
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? jobTitle = null,Object? companyName = null,Object? submittedAt = null,Object? status = null,}) {
